    ...
    reducers: {
        ...
        like: (state, action) => {
            ...
            if (!state.currentVideo.like.includes(action.payload)) {
                ...
                state.currentVideo.dislike.splice(state.currentVideo.dislike.findIndex(userId => userId === action.payload), 1)
        ...
        dislike: (state, action) => {
            ...
            if (!state.currentVideo.dislike.includes(action.payload)) {
                ...
                state.currentVideo.like.splice(state.currentVideo.like.findIndex(userId => userId === action.payload), 1)
